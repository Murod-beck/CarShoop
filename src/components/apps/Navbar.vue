  ...
  data() {
    return {
      ...
      menus: [
        ...
        { id: 1, title: 'Avto Iforlari', logo: '', url: '/flavors' },
        { id: 1, title: 'Aksessuarlar', logo: '', url: '/accessories' },
        { id: 1, title: 'Yangiliklar', logo: '', url: '/news' },
      ],
    };
  },
  mounted() {
    this.Menu = M.Sidenav.init(this.$refs.sideNav, {
      draggable: false,
    });
  },
  props: {},
